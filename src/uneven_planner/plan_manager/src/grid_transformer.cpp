...
marker_pub_(n.advertise<visualization_msgs::MarkerArray>("visualization_marker_zean", 10))   //zean
{
    ...
    publish_rater = n.createTimer(ros::Duration(50.0), &GridTransformer::publishHandler, this); //5  zean 8-14 20:28t
...
void GridTransformer::pointProcessing(PointCloud<PointType>::Ptr pt_in){
    ...
    //2.5 before 2-19
    // ne.setRadiusSearch(voxelSize*5); 
    //5 before 2-20 23:20 for first page
    ne.setRadiusSearch(voxelSize*5);
